      ...
      <div className="privacy-policy-div">
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              "We", "Us" or "Our" in this Agreement) refers to Jamhacks, 650
              Laurelwood Dr, Waterloo, ON N2V 2V1.
            </p>
          </li>
          <li>
        ...
        <ul>
          <li>
            ...
            <p>
              You can prevent Google from using your information for analytics
              purposes by opting-out with the browser extension.
            </p>
            <p>
